  ...
  _createClass(DateRange, [{
    ...
    value: function handleSelect(date, source) {
      ...
      if (date.startDate && date.endDate) {
        ...
        var _shownDate = [date['startDate'], date['startDate'].clone().add(1, 'months')];
        this.setState({ shownDate: _shownDate });
      ...
      var shownDate = [range['startDate'], range['startDate'].clone().add(1, 'months')];
    ...
    value: function render() {
      ...
      var shownDate = _state.shownDate;
      ...
      return _react2['default'].createElement(
        ...
        (function () {
          ...
          for (var i = Number(calendars) - 1; i >= 0; i--) {
            _calendars[_method](_react2['default'].createElement(
              'div',
              { key: i, className: "calendar-" + (i + 1) },
              _react2['default'].createElement(_CalendarJs2['default'], {
